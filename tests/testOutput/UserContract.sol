...
contract ExampleUserContract is RulesEngineClientCustom {
     ...
     */
    function transfer(address to, uint256 value, uint256 somethingElse) public checkRulesBeforetransfer(to, value, somethingElse) checkRulesBeforetransfer(to, value, somethinElse) returns (bool) {
        somethingElse;
        to;
        value;
    }
