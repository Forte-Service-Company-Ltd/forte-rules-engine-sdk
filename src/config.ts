...
export const initialAccount: PrivateKeyAccount = privateKeyToAccount(foundryPrivateKey)
export const foundryAccountAddress: `0x${string}` = '0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266'

const secondaryFoundryPrivateKey: `0x${string}` = '0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d'
export const secondaryAccount: PrivateKeyAccount = privateKeyToAccount(secondaryFoundryPrivateKey)
const secondaryFoundAccountAddress: `0x${string}` = '0x70997970C51812dc3A010C7d01b50e0d17dc79C8'
 ...
 */
export const createTestConfig = async (primary: boolean = true): Promise<Config> => {
  _config = createConfig({
    ...
    connectors: [
      mock({
        accounts: [primary ? foundryAccountAddress : secondaryFoundAccountAddress],
      }),
    ],
  })
  return _config
